 ...
 * abstracci�n b�sica del controlador de una entidad. Este es responsable de monitorear
 * y procesar las entradas del usuario. Genera las correspondientes <code>ITask</code>
 * en respuesta a los eventos de entrada. 2
 * <p>
 * <code>Controller</code> es, adem�s, responsable de monitorear el estado de la
 ...
 *  modificar la <code>IDynamicEntity</code> continuamente a trav�s de las distintas
