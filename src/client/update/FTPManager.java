...
public class FTPManager {
	 ...
	 */
	public FTPManager(final JProgressBar pgrsBar, 
			final JProgressBar ovPrgsBar) {
	 ...
	 * @throws FTPException Señal de que ocurrio una excepcion FTP
	 */
	public final void downloadFile(final String fileName,
			final String localPath) throws IOException, FTPException {
	 ...
	 * @throws FTPException Señal de que ocurrio una excepcion FTP
	 */
	public final void changeDir(final String directory) 
