...
public class ClientCommunication {
	 ...
	 */
	public final void setChannelConteiner(
			final ChannelConteiner newChannelConteiner) {
	 ...
	 */
	public final void setClientListener(
			final ClientListener newClientListener) {
	 ...
	 * el mensaje.
	 */
	public void sendEvent(final IMessage message, final ClientChannel channel)
		...
		try {
			...
			throw new SendMessageException(
					"No se pudo enviar el mensaje por el canal "
					+ channel.getName(), ioe, message);
		}
	}
	...
	public void send(final IMessage message) throws SendMessageException {
		try {
			...
			LOGGER.log(Level.WARNING, "Exception: {0}", ioe);
			throw new SendMessageException(
					"No se pudo enviar el mensaje directo al servidor",
					ioe, message);
		}
	}
