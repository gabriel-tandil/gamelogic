 ...
 * por un tipo de canal.<BR/>
 * Esta clase puede mantiene asociacion entre los tipos de mensajes y los tipos
 * de canales.<BR/>
 * 
...
public class ChannelTypeForMsgTypes {
	 ...
	 * devuelve null.
	 * 
	 * @param msgType El tipo del mensaje.
	 * @param ChannelType El tipo del canal.
	 ...
	 * 
	 * @param msgType El tipo de mensaje.
	 ...
	 * 
	 * @param channelTypeForMsgTypes Hastable que se usara para setear la
	 *        hastable interna.
	 * @author Javier
	 */
	public void setChannelTypeForMsgTypes(
			Hashtable<String, String> channelTypeForMsgTypes) {
