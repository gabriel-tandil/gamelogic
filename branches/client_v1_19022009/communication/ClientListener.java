...
public class ClientListener implements ClientChannelListener,
	...
	private static final Logger LOGGER = Logger
			.getLogger(ClientCommunication.class.getName());
	...
	public final void leftChannel(final ClientChannel channel) {
		GameContext.getClientCommunication().getChannelConteiner()
	...
	public final ClientChannelListener joinedChannel(final ClientChannel channel) {
		...
		GameContext.getClientCommunication().getChannelConteiner().addChannel(
				channel);
		return this;
	}
