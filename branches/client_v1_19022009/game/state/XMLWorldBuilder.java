...
public class XMLWorldBuilder implements IWorldBuilder {
	...
	public Skybox setupSky() {
		...
		try {
			SimpleResourceLocator srl = new SimpleResourceLocator(Game.class
					.getClassLoader().getResource("cielo/"));
		...
		sb.setTexture(Skybox.Face.East, TextureManager.loadTexture(
				...
				Texture.MinificationFilter.NearestNeighborLinearMipMap,
				Texture.MagnificationFilter.NearestNeighbor));
		sb.setTexture(Skybox.Face.Up, TextureManager.loadTexture("cielo_6.jpg",
				Texture.MinificationFilter.NearestNeighborLinearMipMap,
				Texture.MagnificationFilter.NearestNeighbor));
	...
	private void getWorld(Node nodeRoot) {
		...
		if (filename != null) {
			try {
				...
				for (Iterator<Element> i = root.getChildren("node").iterator(); i
						.hasNext();) {
					Element node = i.next();
					...
					hijo = cargarModelo(textures + model.getValue()
							+ "_Piso.3ds");
					Quaternion q = hijo.getLocalRotation();
					q = q.fromAngleAxis((float) -Math.PI / 2, new Vector3f(1,
							0, 0));
					hijo.setLocalRotation(q);
					world.attachChild(hijo);
				...
				for (Iterator<Element> i = root.getChildren("accesspoints")
						.iterator(); i.hasNext();) {
					Element node = i.next();
	...
	public Node cargarModelo(String modelFile) {
		...
		String modelBinary = modelFile.substring(0,
				...
				+ "jbin";
		URL modelURL = ModelLoader.class.getClassLoader().getResource(
				modelBinary);
		...
		if (modelURL == null) {
			...
			try {
				...
				// BinaryExporter.getInstance().save((Savable)loadedModel, new
				// File(modelBinary));
			} catch (IOException e) {
				e.printStackTrace();
				return null;
	...
	private Node parseNode(Node child, Element node)
		...
		if (list != null)
			for (i = list.iterator(); i.hasNext();) {
				...
				if (param1.equals("CombineClosest"))
					child
							.setLightCombineMode(Spatial.LightCombineMode.CombineClosest);
				else if (param1.equals("CombineClosestEnabled"))
					child
							.setLightCombineMode(Spatial.LightCombineMode.CombineClosestEnabled);
				else if (param1.equals("CombineFirst"))
					child
							.setLightCombineMode(Spatial.LightCombineMode.CombineFirst);
		...
		if (list != null)
			for (i = list.iterator(); i.hasNext();) {
				...
				// Quaternion
				// param1=parseQuaternion(e.getChildren("quaternion"));
				// child.setLocalRotation(param1);
			}
		...
		if (list != null)
			for (i = list.iterator(); i.hasNext();) {
				...
				child.setLocalTranslation(Float.valueOf(param1), Float
						.valueOf(param2), Float.valueOf(param3));
			}
		...
		if (list != null)
			for (i = list.iterator(); i.hasNext();) {
				e = (Element) i.next();
				BoundingVolume param1 = parseBoundingVolume(e
						.getChildren("boundingVolume"));
		...
		if (list != null)
			for (i = list.iterator(); i.hasNext();) {
				e = (Element) i.next();
				RenderState param1 = parseRenderState(e
						.getChildren("renderState"));
		...
		if (list != null)
			for (i = list.iterator(); i.hasNext();) {
				...
				if (param1.equals("AlwaysNormalize"))
					...
					child
							.setTextureCombineMode(Spatial.TextureCombineMode.CombineClosestEnabled);
				else if (param1.equals("NormalizeIfScaled"))
					child
							.setTextureCombineMode(Spatial.TextureCombineMode.CombineFirst);
				else if (param1.equals("Off"))
					child
							.setTextureCombineMode(Spatial.TextureCombineMode.Inherit);
				else if (param1.equals("UseProvided"))
		...
		if (list != null)
			for (i = list.iterator(); i.hasNext();) {
				...
				if (param2 == null)
					...
					child.setZOrder(Integer.valueOf(param1), Boolean
							.valueOf(param2));
			}
		return child;
	}
		...
		if (children != null)
			for (i = children.iterator(); i.hasNext();) {
				...
				if (list != null)
					for (i = list.iterator(); i.hasNext();) {
						e2 = (Element) i.next();
						float f1 = Float.valueOf(e2.getAttribute("param1")
								.getValue());
						float f2 = Float.valueOf(e2.getAttribute("param2")
								.getValue());
						float f3 = Float.valueOf(e2.getAttribute("param3")
								.getValue());
				...
				if (list != null)
					for (i = list.iterator(); i.hasNext();) {
						...
						float f1 = Float.valueOf(e2.getAttribute("param1")
								.getValue());
						Vector3f v = parseVector3f(e2.getChildren("vector3f"));
						LineSegment l = parseLineSegment(e2
								.getChildren("lineSegment"));
				...
				if (list != null)
					for (i = list.iterator(); i.hasNext();) {
						e2 = (Element) i.next();
						bv.setCheckPlane(Integer.valueOf(e2.getAttribute(
								"param1").getValue()));
					}
		...
		if (children != null)
			for (i = children.iterator(); i.hasNext();) {
				...
				if (list != null)
					for (i = list.iterator(); i.hasNext();) {
						e2 = (Element) i.next();
						ls.setDirection(parseVector3f(e2
				...
				if (list != null)
					for (i = list.iterator(); i.hasNext();) {
						e2 = (Element) i.next();
						ls.setExtent(Float.valueOf(e2.getAttribute("param1")
								.getValue()));
					}
	...
	private Renderer parseRenderer(List children) {
		...
		if (children != null)
			for (i = children.iterator(); i.hasNext();) {
				e = (Element) i.next();
				int param1 = Integer.valueOf(e.getAttribute("param1")
						.getValue());
				int param2 = Integer.valueOf(e.getAttribute("param2")
						.getValue());
				...
				if (list != null)
					for (i = list.iterator(); i.hasNext();) {
						...
						float f3 = Float.valueOf(e2.getAttribute("param3")
								.getValue());
						float f4 = Float.valueOf(e2.getAttribute("param4")
								.getValue());
				...
				if (list != null)
					for (i = list.iterator(); i.hasNext();) {
						e2 = (Element) i.next();
						lw.setHeadless(Boolean.valueOf(e2
								.getAttribute("param1").getValue()));
					}
			...
			for (i = children.iterator(); i.hasNext();) {
				...
				if (list != null)
					for (i = list.iterator(); i.hasNext();) {
						e2 = (Element) i.next();
						lw
								.setAxes(parseQuaternion(e2
										.getChildren("quaternion")));
					}
				...
				if (list != null)
					for (i = list.iterator(); i.hasNext();) {
						...
						lw.setDataOnly(Boolean.valueOf(e2
								.getAttribute("param1").getValue()));
					}
				...
				if (list != null)
					for (i = list.iterator(); i.hasNext();) {
						e2 = (Element) i.next();
						lw.setDirection(parseVector3f(e2
								.getChildren("vector3f")));
					}
				...
				if (list != null)
					for (i = list.iterator(); i.hasNext();) {
						...
						Quaternion q1 = parseQuaternion(e2
								.getChildren("quaternion"));
						lw.setFrame(v1, q1);
					}
				...
				if (list != null)
					for (i = list.iterator(); i.hasNext();) {
						...
						float f4 = Float.valueOf(e2.getAttribute("param4")
								.getValue());
						float f5 = Float.valueOf(e2.getAttribute("param5")
								.getValue());
						float f6 = Float.valueOf(e2.getAttribute("param6")
								.getValue());
				...
				if (list != null)
					for (i = list.iterator(); i.hasNext();) {
						e2 = (Element) i.next();
						lw.setFrustumBottom(Float.valueOf(e2.getAttribute(
								"param1").getValue()));
				...
				if (list != null)
					for (i = list.iterator(); i.hasNext();) {
						e2 = (Element) i.next();
						lw.setFrustumFar(Float.valueOf(e2
								.getAttribute("param1").getValue()));
					}
				...
				if (list != null)
					for (i = list.iterator(); i.hasNext();) {
						e2 = (Element) i.next();
						lw.setFrustumNear(Float.valueOf(e2.getAttribute(
								"param1").getValue()));
					}
				...
				if (list != null)
					for (i = list.iterator(); i.hasNext();) {
						e2 = (Element) i.next();
						lw.setFrustumRight(Float.valueOf(e2.getAttribute(
								"param1").getValue()));
				...
				if (list != null)
					for (i = list.iterator(); i.hasNext();) {
						e2 = (Element) i.next();
						lw.setFrustumTop(Float.valueOf(e2
								.getAttribute("param1").getValue()));
					}
				...
				if (list != null)
					for (i = list.iterator(); i.hasNext();) {
						e2 = (Element) i.next();
						lw.setParallelProjection(Boolean.valueOf(e2
								.getAttribute("param1").getValue()));
				...
				if (list != null)
					for (i = list.iterator(); i.hasNext();) {
						e2 = (Element) i.next();
						lw.setPlaneState(Integer.valueOf(e2.getAttribute(
								"param1").getValue()));
					}
				...
				if (list != null)
					for (i = list.iterator(); i.hasNext();) {
						e2 = (Element) i.next();
						lw.setViewPortBottom(Float.valueOf(e2.getAttribute(
								"param1").getValue()));
					}
				...
				if (list != null)
					for (i = list.iterator(); i.hasNext();) {
						e2 = (Element) i.next();
						lw.setViewPortLeft(Float.valueOf(e2.getAttribute(
								"param1").getValue()));
					}
				...
				if (list != null)
					for (i = list.iterator(); i.hasNext();) {
						e2 = (Element) i.next();
						lw.setViewPortRight(Float.valueOf(e2.getAttribute(
								"param1").getValue()));
					}
				...
				if (list != null)
					for (i = list.iterator(); i.hasNext();) {
						e2 = (Element) i.next();
						lw.setViewPortTop(Float.valueOf(e2.getAttribute(
								"param1").getValue()));
					}
			}
		return lw;
	...
	private RenderState parseRenderState(List children) {
		...
		if (children != null) {
			...
			if (i.hasNext()) {
					...
					if (it2.hasNext()) {
						...
						if (lis2 != null)
							for (Iterator i2 = lis2.iterator(); i.hasNext();) {
								...
								if (param1.equals("Add"))
									bs
											.setBlendEquation(BlendState.BlendEquation.Add);
								else if (param1.equals("Max"))
									bs
											.setBlendEquation(BlendState.BlendEquation.Max);
								else if (param1.equals("Min"))
									bs
											.setBlendEquation(BlendState.BlendEquation.Min);
								else if (param1.equals("ReverseSubtract"))
									bs
											.setBlendEquation(BlendState.BlendEquation.ReverseSubtract);
								else if (param1.equals("Subtract"))
									bs
											.setBlendEquation(BlendState.BlendEquation.Subtract);
							}
						...
						if (lis2 != null)
							for (Iterator i2 = lis2.iterator(); i.hasNext();) {
								...
								if (param1.equals("Add"))
									bs
											.setBlendEquationAlpha(BlendState.BlendEquation.Add);
								else if (param1.equals("Max"))
									bs
											.setBlendEquationAlpha(BlendState.BlendEquation.Max);
								else if (param1.equals("Min"))
									bs
											.setBlendEquationAlpha(BlendState.BlendEquation.Min);
								else if (param1.equals("ReverseSubtract"))
									bs
											.setBlendEquationAlpha(BlendState.BlendEquation.ReverseSubtract);
								else if (param1.equals("Subtract"))
									bs
											.setBlendEquationAlpha(BlendState.BlendEquation.Subtract);
							}
						...
						if (lis2 != null)
							for (Iterator i2 = lis2.iterator(); i.hasNext();) {
								...
								if (param1.equals("Add"))
									bs
											.setBlendEquationRGB(BlendState.BlendEquation.Add);
								else if (param1.equals("Max"))
									bs
											.setBlendEquationRGB(BlendState.BlendEquation.Max);
								else if (param1.equals("Min"))
									bs
											.setBlendEquationRGB(BlendState.BlendEquation.Min);
								else if (param1.equals("ReverseSubtract"))
									bs
											.setBlendEquationRGB(BlendState.BlendEquation.ReverseSubtract);
								else if (param1.equals("Subtract"))
									bs
											.setBlendEquationRGB(BlendState.BlendEquation.Subtract);
							}
						lis2 = elem2.getChildren("constantColor");
						if (lis2 != null)
							for (Iterator i2 = lis2.iterator(); i.hasNext();) {
								e = (Element) i2.next();
								ColorRGBA param1 = parseColor(e
										.getChildren("colorRGBA"));
						...
						if (lis2 != null)
							for (Iterator i2 = lis2.iterator(); i.hasNext();) {
								...
								if (param1.equals("ConstantAlpha"))
									bs
											.setDestinationFunction(BlendState.DestinationFunction.ConstantAlpha);
								else if (param1.equals("ConstantColor"))
									bs
											.setDestinationFunction(BlendState.DestinationFunction.ConstantColor);
									...
									bs
											.setDestinationFunction(BlendState.DestinationFunction.OneMinusConstantColor);
								else if (param1
										.equals("OneMinusDestinationAlpha"))
									bs
											.setDestinationFunction(BlendState.DestinationFunction.OneMinusDestinationAlpha);
								else if (param1.equals("OneMinusSourceAlpha"))
									bs
											.setDestinationFunction(BlendState.DestinationFunction.OneMinusSourceAlpha);
								else if (param1.equals("OneMinusSourceColor"))
									bs
											.setDestinationFunction(BlendState.DestinationFunction.OneMinusSourceColor);
									...
									bs
											.setDestinationFunction(BlendState.DestinationFunction.Zero);
							}
						...
						if (lis2 != null)
							for (Iterator i2 = lis2.iterator(); i.hasNext();) {
								...
								if (param1.equals("ConstantAlpha"))
									bs
											.setDestinationFunctionAlpha(BlendState.DestinationFunction.ConstantAlpha);
								else if (param1.equals("ConstantColor"))
									bs
											.setDestinationFunctionAlpha(BlendState.DestinationFunction.ConstantColor);
								else if (param1.equals("DestinationAlpha"))
									bs
											.setDestinationFunctionAlpha(BlendState.DestinationFunction.DestinationAlpha);
								else if (param1.equals("One"))
									bs
											.setDestinationFunctionAlpha(BlendState.DestinationFunction.One);
								else if (param1.equals("OneMinusConstantAlpha"))
									bs
											.setDestinationFunctionAlpha(BlendState.DestinationFunction.OneMinusConstantAlpha);
								else if (param1.equals("OneMinusConstantColor"))
									bs
											.setDestinationFunctionAlpha(BlendState.DestinationFunction.OneMinusConstantColor);
								else if (param1
										.equals("OneMinusDestinationAlpha"))
									bs
											.setDestinationFunctionAlpha(BlendState.DestinationFunction.OneMinusDestinationAlpha);
								else if (param1.equals("OneMinusSourceAlpha"))
									bs
											.setDestinationFunctionAlpha(BlendState.DestinationFunction.OneMinusSourceAlpha);
								else if (param1.equals("OneMinusSourceColor"))
									bs
											.setDestinationFunctionAlpha(BlendState.DestinationFunction.OneMinusSourceColor);
								else if (param1.equals("SourceAlpha"))
									bs
											.setDestinationFunctionAlpha(BlendState.DestinationFunction.SourceAlpha);
								else if (param1.equals("SourceColor"))
									bs
											.setDestinationFunctionAlpha(BlendState.DestinationFunction.SourceColor);
								else if (param1.equals("Zero"))
									bs
											.setDestinationFunctionAlpha(BlendState.DestinationFunction.Zero);
							}
						...
						if (lis2 != null)
							for (Iterator i2 = lis2.iterator(); i.hasNext();) {
								...
								if (param1.equals("ConstantAlpha"))
									bs
											.setDestinationFunctionRGB(BlendState.DestinationFunction.ConstantAlpha);
								else if (param1.equals("ConstantColor"))
									bs
											.setDestinationFunctionRGB(BlendState.DestinationFunction.ConstantColor);
								else if (param1.equals("DestinationAlpha"))
									bs
											.setDestinationFunctionRGB(BlendState.DestinationFunction.DestinationAlpha);
								else if (param1.equals("One"))
									bs
											.setDestinationFunctionRGB(BlendState.DestinationFunction.One);
								else if (param1.equals("OneMinusConstantAlpha"))
									bs
											.setDestinationFunctionRGB(BlendState.DestinationFunction.OneMinusConstantAlpha);
								else if (param1.equals("OneMinusConstantColor"))
									bs
											.setDestinationFunctionRGB(BlendState.DestinationFunction.OneMinusConstantColor);
								else if (param1
										.equals("OneMinusDestinationAlpha"))
									bs
											.setDestinationFunctionRGB(BlendState.DestinationFunction.OneMinusDestinationAlpha);
								else if (param1.equals("OneMinusSourceAlpha"))
									bs
											.setDestinationFunctionRGB(BlendState.DestinationFunction.OneMinusSourceAlpha);
								else if (param1.equals("OneMinusSourceColor"))
									bs
											.setDestinationFunctionRGB(BlendState.DestinationFunction.OneMinusSourceColor);
								else if (param1.equals("SourceAlpha"))
									bs
											.setDestinationFunctionRGB(BlendState.DestinationFunction.SourceAlpha);
								else if (param1.equals("SourceColor"))
									bs
											.setDestinationFunctionRGB(BlendState.DestinationFunction.SourceColor);
								else if (param1.equals("Zero"))
									bs
											.setDestinationFunctionRGB(BlendState.DestinationFunction.Zero);
							}
						...
						if (lis2 != null)
							for (Iterator i2 = lis2.iterator(); i.hasNext();) {
								...
								if (param1.equals("ConstantAlpha"))
									bs
											.setSourceFunction(BlendState.SourceFunction.ConstantAlpha);
								else if (param1.equals("ConstantColor"))
									bs
											.setSourceFunction(BlendState.SourceFunction.ConstantColor);
								else if (param1.equals("DestinationAlpha"))
									bs
											.setSourceFunction(BlendState.SourceFunction.DestinationAlpha);
								else if (param1.equals("DestinationColor"))
									bs
											.setSourceFunction(BlendState.SourceFunction.DestinationColor);
								else if (param1.equals("One"))
									bs
											.setSourceFunction(BlendState.SourceFunction.One);
								else if (param1.equals("OneMinusConstantAlpha"))
									bs
											.setSourceFunction(BlendState.SourceFunction.OneMinusConstantAlpha);
								else if (param1.equals("OneMinusConstantColor"))
									bs
											.setSourceFunction(BlendState.SourceFunction.OneMinusConstantColor);
								else if (param1
										.equals("OneMinusDestinationAlpha"))
									bs
											.setSourceFunction(BlendState.SourceFunction.OneMinusDestinationAlpha);
								else if (param1.equals("OneMinusSourceAlpha"))
									bs
											.setSourceFunction(BlendState.SourceFunction.OneMinusSourceAlpha);
								else if (param1.equals("SourceAlpha"))
									bs
											.setSourceFunction(BlendState.SourceFunction.SourceAlpha);
								else if (param1.equals("SourceAlphaSaturate"))
									bs
											.setSourceFunction(BlendState.SourceFunction.SourceAlphaSaturate);
								else if (param1.equals("Zero"))
									bs
											.setSourceFunction(BlendState.SourceFunction.Zero);
							}
						...
						if (lis2 != null)
							for (Iterator i2 = lis2.iterator(); i.hasNext();) {
								...
								if (param1.equals("ConstantAlpha"))
									bs
											.setSourceFunctionAlpha(BlendState.SourceFunction.ConstantAlpha);
								else if (param1.equals("ConstantColor"))
									bs
											.setSourceFunctionAlpha(BlendState.SourceFunction.ConstantColor);
								else if (param1.equals("DestinationAlpha"))
									bs
											.setSourceFunctionAlpha(BlendState.SourceFunction.DestinationAlpha);
								else if (param1.equals("DestinationColor"))
									bs
											.setSourceFunctionAlpha(BlendState.SourceFunction.DestinationColor);
								else if (param1.equals("One"))
									bs
											.setSourceFunctionAlpha(BlendState.SourceFunction.One);
								else if (param1.equals("OneMinusConstantAlpha"))
									bs
											.setSourceFunctionAlpha(BlendState.SourceFunction.OneMinusConstantAlpha);
								else if (param1.equals("OneMinusConstantColor"))
									bs
											.setSourceFunctionAlpha(BlendState.SourceFunction.OneMinusConstantColor);
								else if (param1
										.equals("OneMinusDestinationAlpha"))
									bs
											.setSourceFunctionAlpha(BlendState.SourceFunction.OneMinusDestinationAlpha);
								else if (param1.equals("OneMinusSourceAlpha"))
									bs
											.setSourceFunctionAlpha(BlendState.SourceFunction.OneMinusSourceAlpha);
								else if (param1.equals("SourceAlpha"))
									bs
											.setSourceFunctionAlpha(BlendState.SourceFunction.SourceAlpha);
								else if (param1.equals("SourceAlphaSaturate"))
									bs
											.setSourceFunctionAlpha(BlendState.SourceFunction.SourceAlphaSaturate);
								else if (param1.equals("Zero"))
									bs
											.setSourceFunctionAlpha(BlendState.SourceFunction.Zero);
							}
						...
						if (lis2 != null)
							for (Iterator i2 = lis2.iterator(); i.hasNext();) {
								...
								if (param1.equals("ConstantAlpha"))
									bs
											.setSourceFunctionRGB(BlendState.SourceFunction.ConstantAlpha);
								else if (param1.equals("ConstantColor"))
									bs
											.setSourceFunctionRGB(BlendState.SourceFunction.ConstantColor);
								else if (param1.equals("DestinationAlpha"))
									bs
											.setSourceFunctionRGB(BlendState.SourceFunction.DestinationAlpha);
								else if (param1.equals("DestinationColor"))
									bs
											.setSourceFunctionRGB(BlendState.SourceFunction.DestinationColor);
								else if (param1.equals("One"))
									bs
											.setSourceFunctionRGB(BlendState.SourceFunction.One);
								else if (param1.equals("OneMinusConstantAlpha"))
									bs
											.setSourceFunctionRGB(BlendState.SourceFunction.OneMinusConstantAlpha);
								else if (param1.equals("OneMinusConstantColor"))
									bs
											.setSourceFunctionRGB(BlendState.SourceFunction.OneMinusConstantColor);
								else if (param1
										.equals("OneMinusDestinationAlpha"))
									bs
											.setSourceFunctionRGB(BlendState.SourceFunction.OneMinusDestinationAlpha);
								else if (param1.equals("OneMinusSourceAlpha"))
									bs
											.setSourceFunctionRGB(BlendState.SourceFunction.OneMinusSourceAlpha);
								else if (param1.equals("SourceAlpha"))
									bs
											.setSourceFunctionRGB(BlendState.SourceFunction.SourceAlpha);
								else if (param1.equals("SourceAlphaSaturate"))
									bs
											.setSourceFunctionRGB(BlendState.SourceFunction.SourceAlphaSaturate);
								else if (param1.equals("Zero"))
									bs
											.setSourceFunctionRGB(BlendState.SourceFunction.Zero);
							}
						...
						if (lis2 != null)
							for (Iterator i2 = lis2.iterator(); i.hasNext();) {
								...
								if (param1.equals("Always"))
									bs
											.setTestFunction(BlendState.TestFunction.Always);
								else if (param1.equals("EqualTo"))
									bs
											.setTestFunction(BlendState.TestFunction.EqualTo);
									...
									bs
											.setTestFunction(BlendState.TestFunction.GreaterThanOrEqualTo);
								else if (param1.equals("LessThan"))
									bs
											.setTestFunction(BlendState.TestFunction.LessThan);
								else if (param1.equals("LessThanOrEqualTo"))
									bs
											.setTestFunction(BlendState.TestFunction.LessThanOrEqualTo);
								else if (param1.equals("Never"))
									bs
											.setTestFunction(BlendState.TestFunction.Never);
								else if (param1.equals("NotEqualTo"))
									bs
											.setTestFunction(BlendState.TestFunction.NotEqualTo);
							}
					...
					if (it2.hasNext()) {
						...
						if (lis2 != null) {
							for (it3 = lis2.iterator(); it3.hasNext();) {
								...
								cs.setClipPlaneEquation(
										Integer.valueOf(param1), Double
												.valueOf(param2), Double
												.valueOf(param3), Double
												.valueOf(param4), Double
												.valueOf(param5));
							}
						}
						...
						if (lis2 != null) {
							for (it3 = lis2.iterator(); it3.hasNext();) {
								...
								a = e.getAttribute("param2");
								String param2 = a.getValue();
								cs.setEnableClipPlane(Integer.valueOf(param1),
										Boolean.valueOf(param2));
							}
						}
						lis2 = elem2.getChildren("enabled");
						if (lis2 != null) {
						...
						if (lis2 != null) {
							for (it3 = lis2.iterator(); it3.hasNext();) {
								...
								a = e.getAttribute("param3");
								String param3 = a.getValue();
								cs.setPlaneEq(Integer.valueOf(param1), Integer
										.valueOf(param2), Double
										.valueOf(param3));
							}
						}
						...
						if (lis2 != null)
							for (Iterator i2 = lis2.iterator(); i.hasNext();) {
								...
								if (param1.equals("Back"))
									...
									cus
											.setCullFace(CullState.Face.FrontAndBack);
						...
						if (lis2 != null)
							for (Iterator i2 = lis2.iterator(); i.hasNext();) {
								...
								if (param1.equals("ClockWise"))
									cus
											.setPolygonWind(CullState.PolygonWind.ClockWise);
								else if (param1.equals("CounterClockWise"))
									cus
											.setPolygonWind(CullState.PolygonWind.CounterClockWise);
							}
						return cus;
					}
				}
						...
						if (lis2 != null)
							for (Iterator i2 = lis2.iterator(); i.hasNext();) {
								...
								if (param1.equals("Exponential"))
									fs
											.setDensityFunction(FogState.DensityFunction.Exponential);
								else if (param1.equals("ExponentialSquared"))
									fs
											.setDensityFunction(FogState.DensityFunction.ExponentialSquared);
								else if (param1.equals("Linear"))
									fs
											.setDensityFunction(FogState.DensityFunction.Linear);
							}
						lis2 = elem2.getChildren("enabled");
						if (lis2 != null) {
							for (it3 = lis2.iterator(); it3.hasNext();) {
						...
						if (lis2 != null)
							for (Iterator i2 = lis2.iterator(); i.hasNext();) {
								...
								if (param1.equals("Depth"))
									fs
											.setSource(FogState.CoordinateSource.Depth);
								else if (param1.equals("FogCoords"))
									fs
											.setSource(FogState.CoordinateSource.FogCoords);
							}
					...
					if (it2.hasNext()) {
						...
						if (lis2 != null) {
							for (it3 = lis2.iterator(); it3.hasNext();) {
								...
								String param2 = "";
								for (Iterator it4 = list4.iterator(); it4
										.hasNext();) {
									Element e2 = (Element) it4.next();
									Attribute a2 = e2.getAttribute("param");
									param2 = a2.getValue();
								}
								fps.setParameter(arreFloat, Integer
										.valueOf(param2));
							}
						}
						lis2 = elem2.getChildren("quickCompares");
					...
					if (it2.hasNext()) {
						...
						if (lis2 != null)
							for (Iterator i2 = lis2.iterator(); i.hasNext();) {
								...
								if (param1.equals("Ambient"))
									ms
											.setColorMaterial(MaterialState.ColorMaterial.Ambient);
								else if (param1.equals("AmbientAndDiffuse"))
									ms
											.setColorMaterial(MaterialState.ColorMaterial.AmbientAndDiffuse);
									...
									ms
											.setColorMaterial(MaterialState.ColorMaterial.None);
								else if (param1.equals("Specular"))
									ms
											.setColorMaterial(MaterialState.ColorMaterial.Specular);
							}
						...
						if (lis2 != null)
							for (Iterator i2 = lis2.iterator(); i.hasNext();) {
								...
								if (param1.equals("Ambient"))
									ms
											.setMaterialFace(MaterialState.MaterialFace.Back);
								else if (param1.equals("AmbientAndDiffuse"))
									ms
											.setMaterialFace(MaterialState.MaterialFace.Front);
								else if (param1.equals("Diffuse"))
									ms
						...
						if (lis2 != null)
							for (Iterator i2 = lis2.iterator(); i.hasNext();) {
								...
								if (param1.equals("Flat"))
									...
									ss
											.setShadeMode(ShadeState.ShadeMode.Smooth);
							}
						lis2 = elem2.getChildren("quickCompares");
						if (lis2 != null) {
							for (it3 = lis2.iterator(); it3.hasNext();) {
				...
				/*
				 * proximamente lis=e.getChildren("stencilState");
				 * if(lis!=null){ StencilState sts= new LWJGLStencilState();
				 * it2=lis.iterator(); if(it2.hasNext()){
				 * elem2=(Element)it2.next(); lis2=elem2.getChildren("enabled");
				 * if(lis2!=null){ for(it3=lis2.iterator();it3.hasNext(); ){
				 * e=(Element) it3.next(); a=e.getAttribute("param1"); String
				 * param1=a.getValue(); sts.setEnabled(Boolean.valueOf(param1));
				 * } } lis2=elem2.getChildren("needsRefresh"); if(lis2!=null){
				 * for(it3=lis2.iterator();it3.hasNext(); ){ e=(Element)
				 * it3.next(); a=e.getAttribute("param1"); String
				 * param1=a.getValue();
				 * sts.setNeedsRefresh(Boolean.valueOf(param1)); } }
				 * lis2=elem2.getChildren("stencilFunc"); if(lis2!=null){
				 * for(it3=lis2.iterator();it3.hasNext(); ){ e=(Element)
				 * it3.next(); a=e.getAttribute("param1"); String
				 * param1=a.getValue(); sts(Integer.valueOf(param1)); } }
				 * lis2=elem2.getChildren("stencilFuncMask"); if(lis2!=null){
				 * for(it3=lis2.iterator();it3.hasNext(); ){ e=(Element)
				 * it3.next(); a=e.getAttribute("param1"); String
				 * param1=a.getValue();
				 * sts.setStencilFuncMask(Integer.valueOf(param1)); } }
				 * lis2=elem2.getChildren("stencilMask"); if(lis2!=null){
				 * for(it3=lis2.iterator();it3.hasNext(); ){ e=(Element)
				 * it3.next(); a=e.getAttribute("param1"); String
				 * param1=a.getValue();
				 * sts.setStencilMask(Integer.valueOf(param1)); } }
				 * lis2=elem2.getChildren("stencilOpFail"); if(lis2!=null){
				 * for(it3=lis2.iterator();it3.hasNext(); ){ e=(Element)
				 * it3.next(); a=e.getAttribute("param1"); String
				 * param1=a.getValue();
				 * sts.setStencilOpFail(Integer.valueOf(param1)); } }
				 * lis2=elem2.getChildren("stencilOpZFail"); if(lis2!=null){
				 * for(it3=lis2.iterator();it3.hasNext(); ){ e=(Element)
				 * it3.next(); a=e.getAttribute("param1"); String
				 * param1=a.getValue();
				 * sts.setStencilOpZFail(Integer.valueOf(param1)); } }
				 * lis2=elem2.getChildren("stencilOpZPass"); if(lis2!=null){
				 * for(it3=lis2.iterator();it3.hasNext(); ){ e=(Element)
				 * it3.next(); a=e.getAttribute("param1"); String
				 * param1=a.getValue();
				 * sts.setStencilOpZPass(Integer.valueOf(param1)); } }
				 * lis2=elem2.getChildren("stencilRef"); if(lis2!=null){
				 * for(it3=lis2.iterator();it3.hasNext(); ){ e=(Element)
				 * it3.next(); a=e.getAttribute("param1"); String
				 * param1=a.getValue();
				 * sts.setStencilRef(Integer.valueOf(param1)); } }
				 * lis2=elem2.getChildren("stencilWriteMask"); if(lis2!=null){
				 * for(it3=lis2.iterator();it3.hasNext(); ){ e=(Element)
				 * it3.next(); a=e.getAttribute("param1"); String
				 * param1=a.getValue();
				 * sts.setStencilWriteMask(Integer.valueOf(param1)); } }
				 * lis2=elem2.getChildren("quickCompares"); if(lis2!=null){
				 * for(it3=lis2.iterator();it3.hasNext(); ){ e=(Element)
				 * it3.next(); a=e.getAttribute("param1"); String
				 * param1=a.getValue();
					...
					if (it2.hasNext()) {
						...
						if (lis2 != null)
							for (Iterator i2 = lis2.iterator(); i.hasNext();) {
								...
								if (param1.equals("Affine"))
									ts
											.setCorrectionType(TextureState.CorrectionType.Affine);
								else if (param1.equals("Perspective"))
									ts
											.setCorrectionType(TextureState.CorrectionType.Perspective);
							}
						lis2 = elem2.getChildren("enabled");
						if (lis2 != null) {
							for (it3 = lis2.iterator(); it3.hasNext();) {
						...
						if (lis2 != null) {
							for (it3 = lis2.iterator(); it3.hasNext();) {
								...
								a = e.getAttribute("param1");
								String param1 = a.getValue();
								ts.setTextureCoordinateOffset(Integer
										.valueOf(param1));
							}
						}
						lis2 = elem2.getChildren("quickCompares");
					...
					if (it2.hasNext()) {
						...
						if (lis2 != null) {
							for (it3 = lis2.iterator(); it3.hasNext();) {
								...
								vs.setParameter(arreFloat, Integer
										.valueOf(param2));
							}
						}
						...
						if (lis2 != null) {
							for (it3 = lis2.iterator(); it3.hasNext();) {
								...
								vs.setEnvParameter(arreFloat, Integer
										.valueOf(param2));
							}
						}
						lis2 = elem2.getChildren("quickCompares");
						...
						if (lis2 != null)
							for (Iterator i2 = lis2.iterator(); i.hasNext();) {
								...
								if (param1.equals("Back"))
									...
									ws
											.setFace(WireframeState.Face.FrontAndBack);
							}
					...
					if (it2.hasNext()) {
						...
						if (lis2 != null)
							for (Iterator i2 = lis2.iterator(); i.hasNext();) {
								...
								if (param1.equals("Always"))
									zs
											.setFunction(ZBufferState.TestFunction.Always);
								else if (param1.equals("EqualTo"))
									zs
											.setFunction(ZBufferState.TestFunction.EqualTo);
								else if (param1.equals("GreaterThan"))
									zs
											.setFunction(ZBufferState.TestFunction.GreaterThan);
								else if (param1.equals("GreaterThanOrEqualTo"))
									zs
											.setFunction(ZBufferState.TestFunction.GreaterThanOrEqualTo);
								else if (param1.equals("LessThan"))
									zs
											.setFunction(ZBufferState.TestFunction.LessThan);
								else if (param1.equals("LessThanOrEqualTo"))
									zs
											.setFunction(ZBufferState.TestFunction.LessThanOrEqualTo);
								else if (param1.equals("Never"))
									zs
											.setFunction(ZBufferState.TestFunction.Never);
								else if (param1.equals("NotEqualTo"))
									zs
											.setFunction(ZBufferState.TestFunction.NotEqualTo);
							}
						lis2 = elem2.getChildren("needsRefresh");
						if (lis2 != null) {
							for (it3 = lis2.iterator(); it3.hasNext();) {
	...
	private ColorRGBA parseColor(List children) {
		...
		if (children != null)
			for (i = children.iterator(); i.hasNext();) {
				...
				a = e.getAttribute("param4");
				String param4 = a.getValue();
				color = new ColorRGBA(Float.valueOf(param1), Float
						.valueOf(param2), Float.valueOf(param3), Float
						.valueOf(param4));
			}
		return color;
	}
	...
	private Vector3f parseVector3f(List children) {
		...
		if (children != null)
			for (i = children.iterator(); i.hasNext();) {
				...
				a = e.getAttribute("param3");
				String param3 = a.getValue();
				v3f = new Vector3f(Float.valueOf(param1),
						Float.valueOf(param2), Float.valueOf(param3));
			}
		return v3f;
	}
	...
	private Quaternion parseQuaternion(List children) {
		...
		if (children != null)
			for (i = children.iterator(); i.hasNext();) {
				...
				a = e.getAttribute("param4");
				String param4 = a.getValue();
				q = new Quaternion(Float.valueOf(param1),
						Float.valueOf(param2), Float.valueOf(param3), Float
								.valueOf(param4));
			}
		return q;
	}
	...
	private Matrix3f parseMatrix3f(List children) {
		...
		if (children != null)
			for (i = children.iterator(); i.hasNext();) {
				...
				m3f = new Matrix3f(Float.valueOf(param1),
						Float.valueOf(param2), Float.valueOf(param3), Float
								.valueOf(param4), Float.valueOf(param5), Float
								.valueOf(param6), Float.valueOf(param7), Float
								.valueOf(param8), Float.valueOf(param9));
			}
		return m3f;
	}
	/**
		...
		if (list != null)
			for (i = list.iterator(); i.hasNext();) {
				...
				CollisionManager.getInstace().addAccessPoint(
						param1,
						new AccessPoint((Node) world.getChild(Integer
								.parseInt(param1)),
								(BasicGameState) GameStateManager.getInstance()
										.getChild(param2), nextPosition));
			}
	}
				...
				if (list != null) {
					...
					if (i.hasNext()) {
						...
						if (list1 != null) {
							...
							// Crea la U3DChaseCamera y carga los atributos max
							// y min distance
							...
							if (list1 != null) {
								for (i = list1.iterator(); i.hasNext();) {
									...
									chaser = new U3DChaseCamera(DisplaySystem
											.getDisplaySystem().getRenderer()
											.getCamera(), playerView, props);
									chaser.setMaxDistance(Integer
											.valueOf(maxDistance));
									chaser.setMinDistance(Integer
											.valueOf(minDistance));
								}
							}
						}
